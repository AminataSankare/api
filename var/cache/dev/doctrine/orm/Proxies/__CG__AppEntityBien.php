...
class Bien extends \App\Entity\Bien implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'nomBien', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'etat', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'description', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'prixlocation', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'typebien', '' . "\0" . 'App\\Entity\\Bien' . "\0" . 'localite'];
        }
     ...
     * {@inheritDoc}
     */
    public function setId(int $Id): \App\Entity\Bien
    {
